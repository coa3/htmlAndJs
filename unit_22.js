...
//  Task 4
// Дана переменная a. В переменную делается push. Используя try catch отловите ошибки если они есть. Если ошибка вывести в out-4 число 0. Если не ошибка - то 
// результирующий массив через пробел.
let out4 = document.querySelector('.out');
