...
// ******<br>
//
//Задача решается с помощью цикла. В каждой итерации цикл выводит 6 звездочек. Перенос строки - br. Количество строк (итераций, повторений) 
//цикла вводит пользователь в i-6.

let div6 = document.querySelector('.i-6');
let out6 = "";
