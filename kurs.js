...
// UNIT 24. НЕМНОГО ТЕОРИИ - РАБОТА С POST, GET ЗАПРОСАМИ==============================================================================

// GET ЗАПРОС отправляет в адресной строке ключи и пароли, что видно всем, но ссылка видна точная будет всем!!
// POST  ЗАПРОС  в адресной строке ничего ни видно, идиально для отправки форм содержащих парли и ключи! ссылки не будут одинаковыми на
// разных компьютерах
// < form action="адрес сайта и файла" POST> < /form> ЕСЛИ не указать POST то по умолчанию будет GET!!!
